...
if __name__ == '__main__':
    ...
    parser.add_argument('--encoder_path', type=str, default='./model/encoder-2-1000.ckpt',
                        help='path for trained encoder')
    parser.add_argument('--decoder_path', type=str, default='./model/decoder-2-1000.ckpt',
